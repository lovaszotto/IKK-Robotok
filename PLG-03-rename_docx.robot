...
Rename Docx With Prefix
    ...
    Log To Console    base_name = ${base_name}
    ...
    Run Keyword If    '${rename_prefix}' == 'NONE'    Log To Console    Átnevezés kihagyva: prefix=NONE
    ...
    IF    not ${should_rename}
        Log To Console    Már prefix-szel kezdődik: ${base_name}
        Return From Keyword    ${file_name}
    END
    Log To Console    Rename_Prefix = ${rename_prefix}
    ...
    Log To Console    >>>>>>>>>>>>>>>>> Átnevezve: ${new_full_path} 
