...
#     ${hashcodes_row}=    Get From List    ${existing_hashcodes}    0
#     ${hashcodes_count}=    Get From List    ${hashcodes_row}    0
#     @{existing_repeats}=    Query    SELECT COUNT(*) FROM repeat WHERE file_name = '${file_name}'
#     ${repeats_row}=    Get From List    ${existing_repeats}    0
#     ${repeats_count}=    Get From List    ${repeats_row}    0
